...
class Contenedor {
    ...
    async insertProductById(cartId, productId){
        try {
            ...
            return {msg: 'producto con id '+productId+' fue insertado en carrito con id '+cartId}
        } catch (error) {
...
module.exports = {
    ...
    insertProductByCartIdAndProductId: contenedor.insertProductById,
